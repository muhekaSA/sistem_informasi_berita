                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    while($rows=mysqli_fetch_array($query)){
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../forms/foto_pers/<?php echo $rows['foto']; ?>" style="width:150px;height:150px;" /> </td>
                                            <td><?php echo $rows {'berita'}; ?></td>
                                            <td><?php echo $rows{'tanggal'}; ?></td>
                                        <td>   <a href="hapus_berita.php?id=<?php echo $rows['id_berita'];?>">delete</a></td>
                                             <td><a href="../forms/edit_berita.php?id=<?php echo $rows['id_berita'];?>">Edit</a></td>
                                        </tr>

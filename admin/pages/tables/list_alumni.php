...
<body class="theme-red">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <?php 
            $sql = mysqli_query($koneksi,"SELECT * FROM user where status > 1");
            ...
            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $clr[$rs]; ?></td>
                                            <td><?php echo $city[$cot];?></td>
                                            <td><?php echo $rows['kantor'];?></td>
                                            <td><?php echo $rows['no_telp'];?></td>
                                            <td>
                                             <a href="hapus_alumni.php?id=<?php echo $rows['id_user'];?>">delete</a></td>
                                        </tr>
                                    <?php }?>
                                </table>
                            </div>

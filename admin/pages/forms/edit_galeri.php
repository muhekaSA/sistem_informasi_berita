...
$sql_berita = mysqli_query($koneksi,"SELECT * FROM galeri");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" action="proses_editgaleri.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="ket" value="<?=$read['ket_galeri']; ?> " required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        ...
                                        <br>
                                        <br>
                                        <img src="foto_galeri/<?php echo $read['gambar'];?>" style="width:180px;height:180px;" />
                                ...
                                <input type="hidden" name="idb" value="<?php echo $read['id_galeri'];  ?> ">
